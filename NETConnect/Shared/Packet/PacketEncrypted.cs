...
public class PacketEncrypted
{
    ...
    public PacketEncrypted(byte[] encryptedData, byte[] nonce, byte[] tag, PacketEncryption encryptionType)
    {
    ...
    public byte[] Decrypt(byte[] Key)
    {
        ...
        {
            case PacketEncryption.RSA: return this.encryptedData.DecryptRSA(Key);
            case PacketEncryption.ChaCha20Poly1305: return this.encryptedData.DecryptChaCha(Key, this.Nonce, this.Tag);
        }
    ...
    public static byte[] EncryptUT8Bytes(byte[] data, byte[] Key, PacketEncryption EncryptionType)
    {
        if(Key is not null)
        {
    ...
    //public static byte[] DecryptUTF8Bytes(byte[] data, byte[] Key, PacketEncryption EncryptionType)
    //{

    //}


    //public static bool TryEncryptSend(byte[] unencryptedData, PacketEncryption EncryptionType, PacketAction ActionType, PacketHelper Packer)
    //{
    //    byte[] data = default;
    ...
    //    switch (EncryptionType)
    //    {
    //        case PacketEncryption.RSA: data = EncryptUT8Bytes(unencryptedData, Packer.EncryptionKeys.RemoteRSAPubKey, EncryptionType); break;
    //        case PacketEncryption.ChaCha20Poly1305: data = EncryptUT8Bytes(unencryptedData, Packer.EncryptionKeys.ChaChaKey, EncryptionType); break;
    //    }
